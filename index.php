...
<html class="nojs html" lang="en-US">
 <head>
  ...
  <link rel="stylesheet" type="text/css" href="lib/css/index.css?4031539579" id="pagesheet"/>
  <!-- Other scripts -->
  <script type="text/javascript">
    ...
    <form action="" method="post">
      ...
      <div class="input-group input-group-lg">
        ...
        <div class="input-group input-group-lg">
          ...
          <input type="password" id="email" name="email" class="form-control" placeholder="Contraseña">
        </div>
        <input type="hidden" name="formType" value="Ingresar"/>
        <input type="submit" value="Ingresar" class="btn btn-default">
        
        <a href="registro.php"><button type="button" class="btn btn-default">Registrarse</button></a>
        
        <a href="olvide-mi-cotrasena.php"><button type="button" class="btn btn-link">¿olvido la contraseña?</button></a>
       </form>
 		</div>
 </div>
</div>
   <img class="grpelem" id="u419-4" alt="Tune Source" src="images/u419-4.png" data-image-width="276"/><!-- rasterized frame -->
